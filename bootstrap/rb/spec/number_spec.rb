...
describe ::Acute::Number do
  ...
  it "can add two numbers" do
    other = ::Acute::Number.new(23)
    msg = ::Acute::Message.new("+")
    msg.arguments = [other]
    @num.perform(@num, :msg => msg).value.should be 65
  end
  ...
  it "can subtract two numbers" do
    ...
    msg = ::Acute::Message.new("-")
    msg.arguments = [other]
    @num.perform(@num, :msg => msg).value.should be 19
  end
  ...
  it "can multiply two numbers" do
    ...
    msg = ::Acute::Message.new("*")
    msg.arguments = [other]
    @num.perform(@num, :msg => msg).value.should be 966
  end

  it "can add divide numbers" do
    other = ::Acute::Number.new(2)
    msg = ::Acute::Message.new("/")
    msg.arguments = [other]
    @num.perform(@num, :msg => msg).value.should be 21
  end
  ...
  it "implements bitwise and" do
    ...
    msg.arguments = [other]
    @num.perform(@num, :msg => msg).value.should be 2
    msg.arguments = [::Acute::Number.new(1)]
    @num.perform(@num, :msg => msg).value.should be 0
  end
  ...
  it "implements bitwise or" do
    ...
    msg.arguments = [other]
    @num.perform(@num, :msg => msg).value.should be 63
    msg.arguments = [::Acute::Number.new(100)]
    @num.perform(@num, :msg => msg).value.should be 110
  end
  ...
  it "implements bitwise xor" do
    ...
    msg.arguments = [other]
    @num.perform(@num, :msg => msg).value.should be 61
    msg.arguments = [::Acute::Number.new(100)]
    @num.perform(@num, :msg => msg).value.should be 78
  end

  it "implements bitwise not" do
    msg = ::Acute::Message.new("bitwiseNot")
    @num.perform(@num, :msg => msg).value.should be -43
  end
  ...
  it "implements left shift" do
    ...
    msg.arguments = [other]
    @num.perform(@num, :msg => msg).value.should be 168
  end
